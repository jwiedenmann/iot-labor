...
window_size = 10
df['accX_smoothed'] = df['accX'].rolling(window=window_size, center=True).mean()
df['accY_smoothed'] = df['accY'].rolling(window=window_size, center=True).mean()
df['accZ_smoothed'] = df['accZ'].rolling(window=window_size, center=True).mean()
